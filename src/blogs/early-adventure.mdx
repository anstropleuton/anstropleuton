...
[**View Source**](#/anstropleuton/old-projects/first-game/sources)

<img src={firstGameScreenshot} alt="Showcase - Screenshot of my first ever experiment project in raylib" />

After a while of messing with raylib, I eventually recreated Minesweeper, which was my first completed game project using raylib! To learn more, see my blog post about [A Time-capsule of my Projects Museum](#/anstropleuton/blogs/projects-museum).
